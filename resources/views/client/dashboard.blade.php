            ...
            <div class="w-[70%] h-[60vh] bg-white rounded-md shadow-sm border border-slate-100 overflow-hidden">
                <div class="p-6 border-b border-slate-50 flex justify-between items-center">
                    ...
                    <a href="{{ route('client.projects') }}"
                        class="text-sm cursor-pointer font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-md hover:bg-blue-100 transition-all">
                        View Full List
                    </a>
                </div>
                                    ...
                                    <td class="px-8 py-5 text-right">
                                        <div class="flex justify-end gap-2 transition-all">
                                            <a href="{{ route('client.project.show', $project->id) }}"
                                                class="w-8 h-8 flex items-center justify-center bg-slate-100 text-blue-500 rounded-lg hover:bg-blue-600 hover:text-white transition-all">
